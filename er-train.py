...
import numpy as np
import argparse
os.environ["CUDA_VISIBLE_DEVICES"] = "0,1,2,3"  # "" - CPU, "0" - 1 GPU, "0,1" - MultiGPU
import warnings
...
from datasets import ERdataset
from datasets.precess import *
...
if __name__ == '__main__':
    ...
    parser.add_argument('--commod', default='train',
                        help='train, eval')
    parser.add_argument('--type', default='cell',
                        help='cell, tissue, tem')
    parser.add_argument('--datadir', default='/data/yangshuxin/data/cell/data/1013',
                        help='数据存放的文件夹')
